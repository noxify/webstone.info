<template>
  <Layout>
    <content-header>
      <h1 class="h1 font-extrabold dark:text-gray-400">{{ $page.blog.title}}</h1>
                ...
                <div class="mb-2 sm:mb-0 w-full">
                  <div class="md:flex p-6 pl-0 self-center">
                    ...
                    <div class="text-center md:text-left">
                      ...
                      <div v-if="authors.length>1" class="post-authors font-light text-sm pt-2">
                        Among with
                        <g-link
                          class="font-normal"
                          :to="author.path"
                      ...
                      <div
                        class="font-light tracking-wider leading-relaxed pb-2"
